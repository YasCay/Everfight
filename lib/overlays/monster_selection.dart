...
class MonsterSelectionOverlay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final candidates = [
      Monster(name: 'Leaflet', baseHealth: 90, baseAttack: 10, element: Element.earth, imagePath: 'monster_earth.jpeg'),
      Monster(name: 'Wavey', baseHealth: 80, baseAttack: 18, element: Element.water, imagePath: 'monster_water.jpeg'),
      Monster(name: 'Sparklet', baseHealth: 70, baseAttack: 20, element: Element.fire, imagePath: 'monster_fire.jpeg'),
    ];
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text('HP: ${m.baseHealth}', style: const TextStyle(color: Colors.white70, fontSize: 12)),
                        Text('ATK: ${m.baseAttack}', style: const TextStyle(color: Colors.white70, fontSize: 12)),
                        const SizedBox(height: 6),
                        Image.asset("assets/images/${m.imagePath}", height: 60),
                      ],
                    ),
                  ),
                );
